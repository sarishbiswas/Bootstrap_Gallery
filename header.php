  			...
  			<div class="container">
    			...
    			<div class="collapse navbar-collapse" id="ani">
      				<ul class="nav navbar-nav">
        				...
        				<li><a href="cat-page.php">Cat Gallery</a></li>
        				<li><a href="nature-page.php">Nature Gallery</a></li>
      				</ul>
      				<ul class="nav navbar-nav navbar-right">
        				<li><a href="Sign-up.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
        				<li style="padding-right: 50px;"><a href="log-in.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
      				</ul>
    			</div>
  			</div>
		</nav>
